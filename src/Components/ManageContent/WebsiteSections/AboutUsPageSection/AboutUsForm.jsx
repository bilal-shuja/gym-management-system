...
//   setLoading(true)
//   if(aboutHeading && aboutPara && qualityPara){
//     const aboutObj = {
//       user_id:userID,
//       sec1_para:aboutHeading,
//       about_us_para:aboutPara,
//       our_quality_para:qualityPara
//     }
  
//     axios.post(`${baseURL}api/aboutus`,aboutObj)
//     .then((res)=>{
...
const trainerSection = ()=>{
  ...
  if(aboutHeading && aboutPara && qualityPara && trainerOne &&trainerImgOne && trainerTwo && trainerImgTwo && trainerThree && trainerImgThree && trainerFour && trainerImgFour ){
    setLoading(true)
