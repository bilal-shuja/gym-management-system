...
const GalleryForm = () => {
  ...
  const Youtube = location.state.youtubeLink;
    ...
    const galleryImagesSection = ()=>{
      if(galleryImgOne && galleryImgTwo && galleryImgThree && galleryImgFour && galleryImgFive && galleryImgSix && galleryImgSeven && galleryImgEight && galleryImgNine && fbLink && instaLink && youtubeLink)
      {
        setLoading(true)
