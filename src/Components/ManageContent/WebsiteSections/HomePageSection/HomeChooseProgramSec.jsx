...
const HomeChooseProgramSec = () => {
  ...
  const[progImgOne, setProgImgOne] = useState('');
  ...
  const[progImgTwo , setProgImgTwo] = useState('');
  ...
  const[progImgThree , setProgImgThree] = useState('');
  ...
  const[progImgFour , setProgImgFour] = useState('');
  ...
  const[progImgFourDis, setProgImgFourDis] = useState('');
    ...
    const homeChooseProgramSection = ()=>{
        ...
        if(progHeadOne && progParaOne && progImgOne && progHeadTwo && progParaTwo && progImgTwo &&
          progHeadTwo && progParaTwo && progImgTwo && progHeadThree && progParaThree && progImgThree &&
          progHeadFour && progParaFour && progImgFour
          )
          {
