      ...
      <section id="modal-examples">
        <div className="row">
          ...
          <div className="col-md-4">
            <div className="card"  style={{padding:"1.3em"}}>
          ...
          <div className="col-md-4">
            <div className="card p-2">
              <div className="card-body text-center">
                ...
                {/* modal trigger button */}
                <button type="button" className="btn btn-info mt-5" data-bs-toggle="modal" data-bs-target="#addNewCard" >
                  Show
                </button>
              </div>
            </div>
          ...
          <div className="col-md-4 ">
            ...
            ویب سائٹ کو کیسے اپ ڈیٹ کریں۔      
                ...
                <Link  className="btn btn-info" to="/ManageWebsiteSection"data-bs-target="#pricingModal" style={{marginTop:"0.8em"}}>
                  Show
                </Link>
              </div>
            </div>
